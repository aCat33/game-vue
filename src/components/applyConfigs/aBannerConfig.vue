<template>
  <div>
      ...
      <el-row class="condition">
        ...
        <el-col :span="3">
          <div class="grid-content bg-purple-light">
            <el-button type="primary" @click="addFormVisiable=true">配置banner</el-button>
          </div>
        </el-col>
      </el-row>
    ...
    <el-table :data="tableData" style="width: 90%" border>
      <el-table-column type="index" :index="indexMethod" label="位置" width="50"></el-table-column>
      <el-table-column prop="bannerName" label="banner名" width="100"></el-table-column>
      <el-table-column prop="link" label="查看跳转链接"></el-table-column>
      <el-table-column prop="status" label="样式状态" width="100"></el-table-column>
    ...
    <el-dialog title="添加banner资源" :visible.sync="addFormVisiable">
      <el-form
        ...
        label-position="left"
      >
        <el-form-item label="选择banner资源名">
          <el-select v-model="form.region" placeholder="请选择活动区域">
            <el-option label="区域一" value="shanghai"></el-option>
            <el-option label="区域二" value="beijing"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="设置banner位置">
  ...
  data() {
    return {
      ...
      tableData: [
        {
          bannerName: "五一活动",
          link: "http://localhost:8080/#/bannerConfig",
          status: "上线中",
          city: "普陀区",
